package com.zhangyi.reboundrecyclelayout.customview.ryadapter.wrapper;
...
public class RecyclerAdapterWithHF extends RecyclerView.Adapter<ViewHolder> {
    ...
    public final ViewHolder onCreateViewHolder(ViewGroup viewGroup, int type) {
        ...
        if (type != TYPE_HEADER && type != TYPE_FOOTER) {
            ...
            return new HeaderFooterViewHolder(frameLayout,context);
        }
    }
    ...
    public static class HeaderFooterViewHolder extends ViewHolder {
        ...
        public HeaderFooterViewHolder(View itemView, Context context) {
    ...
    public RecyclerAdapterWithHF(RecyclerView.Adapter<ViewHolder> adapter, Context context) {
        super();
